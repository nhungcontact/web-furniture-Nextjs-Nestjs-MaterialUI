...
import { NotificationList } from '@/mocks/notification.mock'
...
const PerfectScrollbar = styled(Scrollbar)({
  ...styles
})
      ...
      >
        <MenuItem disableRipple>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
            ...
            <Chip
              size='small'
              label={NotificationList.length + ' news'}
              color='primary'
          ...
          {NotificationList.map((item)=>(
            <MenuItem key={item.id} onClick={handleDropdownClose}>
              <Box sx={{ width: '100%', display: 'flex', alignItems: 'center' }}>
                <Avatar alt='Flora' src={item.avatar} />
