...
interface RoomFurnitureTableToolbarProps {
  ...
  handleChange: (event: SelectChangeEvent<RoomFurnitureStatus>) => void;
  status?: RoomFurnitureStatus;
}

export default function RoomFurnitureTableToolbar(props: RoomFurnitureTableToolbarProps) {
  const {
    getValueSearch,
    defaultValueSearch,
    onChangePageSize,
      ...
      <Box sx={{ flex: "1 1 100%" }}>
        ...
        <FormControl sx={{ marginLeft: 2 }}>
          <Select
            ...
            value={status ? status : RoomFurnitureStatus.Active}
            name="type"
            onChange={handleChange}
          >
            <MenuItem value={RoomFurnitureStatus.Active}>
              {RoomFurnitureStatus.Active}
            </MenuItem>
            <MenuItem value={RoomFurnitureStatus.Inactive}>
